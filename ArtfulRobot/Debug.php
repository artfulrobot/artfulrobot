...
class Debug
{
	...
	static protected $htmlspecialchars = 1; // by default; override on \ArtfulRobot\Debug::log()
	 ...
	 */
		...
		{
			$scope=\ArtfulRobot\Utils::arrayValue('function',$backtrace);
			$class=\ArtfulRobot\Utils::arrayValue('class',$backtrace);
			if ($class) $scope = $class . \ArtfulRobot\Utils::arrayValue('type',$backtrace)  . $scope;
